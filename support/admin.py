...
class CommentAdmin(admin.ModelAdmin):
    list_display = (
        'formatted_ticket_id', 'ticket_status', 
        'user', 'created_on'
    )
    ...
    def ticket_status(self, obj):
        return obj.ticket.status if obj.ticket else '-'

    formatted_ticket_id.admin_order_field = 'ticket__id'
    ticket_status.admin_order_field = 'ticket__status'
